...
public class JobOfferRepository {
    ...
    public static final String CREATE_NEW_JOB_OFFER = "insert into tblJob_Offers (jobID, freelancerID) values (:jobID, :freelancerID)";
    ...
    public void createJobOffer(int jobID, int freelancerID) {
        Map<String, Object> params = new HashMap<>();
        params.put("jobID", 100);
        params.put("freelancerID", 100);
