...
create table tblEducation (
  education_ID integer primary key GENERATED BY DEFAULT AS IDENTITY(START WITH 100),
...
create table tblWorkExp (
  workexp_ID integer primary key GENERATED BY DEFAULT AS IDENTITY(START WITH 100),
